...
//
// Source: atoikura/v1/health.proto

package atoikurav1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/yugaumemura/atoikura/gen/go/atoikura/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "atoikura.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/atoikura.v1.HealthService/Check"
)

// HealthServiceClient is a client for the atoikura.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the atoikura.v1.HealthService service. By default,
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_atoikura_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls atoikura.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the atoikura.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/atoikura.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("atoikura.v1.HealthService.Check is not implemented"))
}
